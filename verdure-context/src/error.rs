...
impl ContextError {
    ...
    pub fn profile_not_found(profile: impl Into<String>) -> Self {
        Self::ProfileNotFound { profile: profile.into() }
    }
    ...
    pub fn configuration_file_error(message: impl Into<String>) -> Self {
        Self::ConfigurationFileError { message: message.into() }
    }
...
mod tests {
    ...
    fn test_invalid_configuration_error() {
        ...
        assert_eq!(error.to_string(), "Invalid configuration for key 'port': not a number");
    }
    ...
    fn test_profile_not_found_error() {
        ...
        assert_eq!(error.to_string(), "Environment profile not found: development");
    }
    ...
    fn test_initialization_failed_error() {
        ...
        assert_eq!(error.to_string(), "Context initialization failed: missing required config");
    }
    ...
    fn test_configuration_file_error() {
        ...
        assert_eq!(error.to_string(), "Configuration file error: file not found");
    }
    ...
    fn test_serialization_error() {
        ...
        assert_eq!(error.to_string(), "Serialization error: invalid TOML format");
    }
    ...
    fn test_property_binding_error() {
        ...
        assert_eq!(error.to_string(), "Property binding error for 'database.port': type mismatch");
    }
}